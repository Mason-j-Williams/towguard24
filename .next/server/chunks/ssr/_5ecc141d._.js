...
You are TowGuard24’s Sales & Conversion Agent.
...
- Explain TowGuard24’s value in simple, compelling language.
- Create scripts for calls, SMS, email, and DMs.
- Guide users toward signing up, activating protection, or requesting service.
- Identify the customer’s real motivation and speak directly to it.
...
Your goal is to close deals, convert leads, and grow TowGuard24’s customer base through ethical, high-impact communication.
  `.trim()}};function e(){let a=Object.values(d),[e,f]=(0,c.useState)(a[0]?.id||""),[g,h]=(0,c.useState)([]),[i,j]=(0,c.useState)(""),[k,l]=(0,c.useState)(!1);async function m(){if(!i.trim())return;let a={role:"user",content:i};h(b=>[...b,a]),j(""),l(!0);try{let b=await fetch("/api/agent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({agentId:e,message:a.content,history:g})}),c=await b.json();c.reply?h(a=>[...a,{role:"assistant",content:c.reply}]):h(a=>[...a,{role:"assistant",content:"Error: No reply from agent."}])}catch(a){h(a=>[...a,{role:"assistant",content:"Error contacting agent."}])}l(!1)}return(0,b.jsxs)("div",{style:{padding:20},children:[(0,b.jsx)("h1",{children:"TowGuard24 AI Agents"}),(0,b.jsx)("label",{children:"Select an agent:"}),(0,b.jsx)("select",{value:e,onChange:a=>f(a.target.value),style:{display:"block",marginBottom:20,padding:8},children:a.map(a=>(0,b.jsx)("option",{value:a.id,children:a.name},a.id))}),(0,b.jsx)("div",{style:{border:"1px solid #ccc",padding:10,minHeight:300,marginBottom:20},children:g.map((a,c)=>(0,b.jsxs)("div",{style:{marginBottom:10},children:[(0,b.jsxs)("strong",{children:["user"===a.role?"You":"Agent",":"]})," ",a.content]},c))}),(0,b.jsxs)("div",{style:{display:"flex",gap:10},children:[(0,b.jsx)("input",{value:i,onChange:a=>j(a.target.value),placeholder:"Type your message...",style:{flex:1,padding:10}}),(0,b.jsx)("button",{onClick:m,disabled:k,style:{padding:10},children:k?"Sending...":"Send"})]})]})}a.s(["default",()=>e],84712)}];

//# sourceMappingURL=_5ecc141d._.js.map